package com.enchantedguys.wizardingworldmod.common.entity.projectile;
...
import javax.annotation.Nullable;
    ...
    public class IronKnifeEntity extends AbstractArrowEntity {
        ...
        public IronKnifeEntity(EntityType<? extends net.minecraft.entity.projectile.TridentEntity> type, World worldIn) {
            super(type, worldIn);
        }

        public IronKnifeEntity(World worldIn, LivingEntity thrower, ItemStack thrownStackIn) {
        ...
        @OnlyIn(Dist.CLIENT)
        public IronKnifeEntity(World worldIn, double x, double y, double z) {
