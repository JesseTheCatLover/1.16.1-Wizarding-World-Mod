package com.enchantedguys.wizardingworldmod;

import com.enchantedguys.wizardingworldmod.init.*;
...
public class WizardingWorldMod
{
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo("wwm", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
